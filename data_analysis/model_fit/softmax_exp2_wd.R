...
MyFit<-function(v){
  ...
  save(x,y,BIC,cv,cv_logli,file = paste("softmax_wd_exp2/",v,".Rda",sep = ""),version=2)
...
wholelist=as.list(c(1,2,3,5,6,7))
mclapply(wholelist,MyFit,mc.cores=6)
