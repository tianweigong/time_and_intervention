...
MyFit<-function(v){
  ...
  save(x,y,BIC,file = paste("softmax_exp2/",modvec[mod],".",locvec[loc],".",actvec[act],".Rda",sep = ""),version=2)
  ...
  for (k in subvec){
    ...
    idd[[k]][["BIC"]]=2*(idd[[k]][["dt"]]$value)+par_num*log(45*18)
  }
  save(x,y,BIC,idd,file = paste("softmax_exp2/",modvec[mod],".",locvec[loc],".",actvec[act],".Rda",sep = ""),version=2)
  ...
  save(x,y,BIC,idd,cv,cv_logli,file = paste("softmax_exp2/",modvec[mod],".",locvec[loc],".",actvec[act],".Rda",sep = ""),version=2)
  ...
  save(x,y,BIC,cv,cv_logli,idd,idd_cv,file = paste("softmax_exp2/",modvec[mod],".",locvec[loc],".",actvec[act],".Rda",sep = ""),version=2)
}

ininum=30
par_ini_list=lapply(as.list(rep(NA,ininum)),function(x) c(0.68,-10,2.10)+rnorm(3,0,0.01))
