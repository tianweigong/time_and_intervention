...
df.plot%>%
  ...
  geom_vline(xintercept = 0.84,color=col_A,linetype="dashed")+
  geom_vline(xintercept = 5.255,color=col_C,linetype="dashed")+
  geom_vline(xintercept = 7.755,color=col_B,linetype="dashed")+
  geom_vline(xintercept = 2.340,color=col_eff,linetype="dashed")+
  geom_vline(xintercept = 9.192,color=col_eff,linetype="dashed")+
  theme_bw()+
  ylab("Combined Model")+
  xlab("Time (s)")+
